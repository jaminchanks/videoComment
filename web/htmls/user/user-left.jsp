...
<div class="col-md-3 column">
  ...
  <div class="list-group">
    <div class="list-group-item">
      <a href="#">
        <img src=/resources/img/head/<s:property value='#session.userToBeShow.head'/> "
             width="86px" class="img-rounded"/>
      </a>
      <div style="font-size: x-large;">  <s:property value="#session.userToBeShow.userName" /></div>
      <div style="font-size: small;">  简介：<s:property value="#session.userToBeShow.marks"/></div>
    </div>
